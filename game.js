...
function renderActions(V){const a=$('actionButtons');a.innerHTML='';let prompt='Waiting for opponent…';const me=V.me;
  ...
  if(V.phase==='final'){if(V.offense!==me){prompt='Final chance: play BREAK THROUGH or let the offense succeed.';addAction('NO BREAK THROUGH',()=>sendAction('finalBlitz',{playerId:selectedPlayer,card:null}),'warn');}else prompt='Opponent has one final BREAK THROUGH chance.';}
